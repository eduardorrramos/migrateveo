...
<template>
  <div class="min-h-screen bg-gray-50">
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between items-center mb-8">
        <h1 class="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent text-center sm:text-left">
          {{ t('title') }}
        </h1>
        ...
        <Dialog v-model:open="dialog">
          ...
          <DialogPortal>
            ...
            <DialogContent class="fixed left-[50%] top-[50%] z-50 w-[calc(100%-2rem)] sm:w-full max-w-md translate-x-[-50%] translate-y-[-50%] rounded-xl bg-white p-6 sm:p-8 shadow-2xl">
